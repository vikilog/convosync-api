...
/** Missing/null body → {} (same as former `safeParse(request.body ?? {})`). */
export const sesCredentialsDraftBodySchema = z.preprocess(
  (v) => (v == null ? {} : v),
  sesCredentialsDraftSchema
);

export const saveWorkspaceEmailConfigSchema = z.object({
