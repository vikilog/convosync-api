...
import instagramJourneyRoutes from './modules/instagram-journey/routes/ig-journey.routes.js';
...
import instagramBusinessLoginRoutes from './routes/instagramBusinessLogin.js';
import socialListeningRoutes from './routes/socialListening.js';
import leadsRoutes from './routes/leads.js';
import leadFunnelsRoutes from './routes/leadFunnels.js';
import installedAppsRoutes from './routes/installedApps.js';
...
async function start() {
  ...
  await fastify.register(instagramJourneyRoutes, { prefix: '/api/instagram-journeys' });
  ...
  await fastify.register(instagramBusinessLoginRoutes, { prefix: '/api/instagram-business-login' });
  ...
  await fastify.register(installedAppsRoutes, { prefix: '/api/installed-apps' });
  ...
  initInstagramJourneyModule(prisma);
