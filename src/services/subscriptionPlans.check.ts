...
const serialized = serializeSubscriptionPlan({
  ...
  priceMonthlyUsd: businessSeed.priceMonthlyUsd,
  priceAnnualUsd: businessSeed.priceAnnualUsd,
  priceMonthlyCents: businessSeed.priceMonthlyCents,
  priceAnnualCents: businessSeed.priceAnnualCents,
